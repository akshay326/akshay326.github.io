...
## What do I mean by differentiating a program? 
...
## What have I achieved? How can you use it?
...
Although I've almost approached the last week for GSoC, I'll make sure to improve on the following things post-GSoC too.

1. Making the code independent of SCS.jl ([Issue#38](https://github.com/AKS1996/DiffOpt.jl/issues/38)) - although I did resolve SCS specific code in MatrixOptInterface.jl, but some part of differentiation still relies on SCS specific code. Removing this dependency should generalize differentiation to any available conic solver
2. Derivative in terms of ChainRules.jl - this is one of the foremost suggestions by [@matbesancon](https://github.com/matbesancon); although I couldn't include AD in GSOC timeline well, I've begun discussion with [ChainRules.jl](https://github.com/JuliaDiff/ChainRules.jl) community
...
It wouldn't be wrong to say that at times I was confused with how to make an effective segue from optimization theory to working models. I've been able to develop the codebase because of the biweekly GSoC standups, the JuMP developer call, numerous issues/PR discussions, and slack threads.

> 100+ commits, 20+ PRs and 3000+ lines of code and counting

Finally, I would like to thank Google Summer of Code team for providing me this great learning opportunity amidst the COVID pandemic. 
