...
![Four graph topologies used in the experiment](/assets/images/graph-icl/original_graph_topologies.svg)
...
<img src="/assets/images/graph-icl/alignment_curves_per_graph.webp" alt="Alignment score by context length" width="5520" height="1200" loading="lazy">
...
Each graph has its own context slider. The topology on the left shows the original layout with node names; the fixed-basis PCA on the right tracks the same nodes as context grows. Move a slider to inspect that graph before and after the representation changes.

  <iframe src="/assets/images/graph-icl/pca_graph_slider.html" title="Per-graph context sliders with topology and fixed-basis PCA" loading="eager" style="width:100%;height:1650px;border:1px solid #d7dce5;border-radius:12px;background:#fff"></iframe>
  <script>
  (function () {
...
<img src="/assets/images/graph-icl/Lstar_vs_tau.webp" alt="Estimated transition points versus the spectral mixing proxy" width="1400" height="900" loading="lazy">
...
<img src="/assets/images/graph-icl/accuracy_curves_per_graph.webp" alt="Exact next-neighbor accuracy rises with context" width="2000" height="650" loading="lazy">
